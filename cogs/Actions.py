...
class Actions(commands.Cog):
    ...
    async def honk(self, ctx, args):
        ...
        embed.set_image(url=f"https://i.pinimg.com/originals/31/b7/34/{id}.gif")
    ...
    async def punch(self, ctx, args):
        ...
        embed.set_image(url="https://i.gifer.com/9eUJ.gif")
        await ctx.send(embed=embed)
    ...
    async def kick(self, ctx, args):
        ...
        embed.set_image(url="https://c.tenor.com/xJyw7SRtDRoAAAAC/anime-punch.gif")
        await ctx.send(embed=embed)
    ...
    async def kiss(self, ctx, args):
        ...
        embed.set_image(url=f"https://aniyuki.com/wp-content/uploads/2021/07/{id}.gif")
        await ctx.send(embed=embed)
    ...
    async def hug(self, ctx, args):
        ...
        embed.set_image(url="https://i.gifer.com/2QEa.gif")
        await ctx.send(embed=embed)
    ...
    async def poke(self, ctx, args):
        ...
        embed.set_image(url="https://c.tenor.com/3dOqO4vVlr8AAAAC/poke-anime.gif")
        await ctx.send(embed=embed)
    ...
    async def bonk(self, ctx, args):
        ...
        embed.set_image(url="https://c.tenor.com/qvvKGZhH0ysAAAAC/anime-girl.gif")
        await ctx.send(embed=embed)
    ...
    async def yeet(self, ctx, args):
        ...
        embed.set_image(url="https://c.tenor.com/gISSJc70lH4AAAAC/yeet-naruto.gif")
        await ctx.send(embed=embed)
    ...
    async def stare(self, ctx, args):
        ...
        embed.set_image(url="https://c.tenor.com/W_o-X6KNuCYAAAAC/anime-stare.gif")
        await ctx.send(embed=embed)
    ...
    async def cuddle(self, ctx, args):
        ...
        embed.set_image(url="https://media.giphy.com/media/PHZ7v9tfQu0o0/giphy.gif")
        await ctx.send(embed=embed)
    ...
    async def insult(self, ctx, args):
        ...
        embed.set_image(url="https://c.tenor.com/LQDCtZP0GpYAAAAC/anime-insult.gif")
        await ctx.send(embed=embed)
    ...
    async def nom(self, ctx, args):
        ...
        embed.set_image(url="https://i.imgur.com/Ns1RBzX.gif")
        await ctx.send(embed=embed)
    ...
    async def highfive(self, ctx, args):
        ...
        embed.set_image(url="https://i.gifer.com/Pvwh.gif")
        await ctx.send(embed=embed)
    ...
    async def bite(self, ctx, args):
        ...
        embed.set_image(url="https://c.tenor.com/w4T323o46uYAAAAC/anime-bite.gif")
        await ctx.send(embed=embed)
